...
const Activities = () => {
  ...
  return (
    ...
    >
    <Link onClick={handleClick} className="z-90 cursor-pointer absolute top-20 left-30 flex items-center gap-2 justify-center w-fit box-border hover:opacity-50">
      <img src={arrow} alt="arrow" className="w-10 h-10" />
      <span className="text-3xl font-semibold" style={{ fontFamily: "Caveat, sans-serif" }}>Volver</span>
    </Link>
    ...
    <div className="flex justify-center gap-6 w-full h-full box-border absolute mt-[412px]">
      <img className="w-105 h-100 " src={albert} alt="Isaac Newton's photo" />
      <img className="w-105 h-100 " src={newton} alt="Isaac Newton's funny photo" />
      <img className="w-105 h-100 " src={maxwell} alt="Isaac Newton's photo" />
    </div>
    ...
    <div className="flex items-center gap-6 justify-center w-full h-full box-border relative mt-[-70px]">
      ...
      <img className="w-70" src={formula} alt="Isaac Newton's funny photo"/>
    </div>

      <img className="w-30 absolute bottom-117 left-45" src={sphere} alt="esfera 3d" />
      <img className="w-20 absolute top-9 left-95 -rotate-20" src={resorte} alt="resorte 3d" />
      <img className="w-50 absolute top-7 left-165 -rotate-55" src={flor} alt="flor 3d" />
      <img className="w-25 absolute top-65 left-110 -rotate-20" src={sol} alt="sol ilustracion" />

      <img className="w-30 absolute top-15 right-135 rotate-5" src={cubito} alt="cubo 3d" />
      <img className="w-37 absolute top-0 right-59 -rotate-15" src={bombillo} alt="bombillo 3d" />
      <img className="w-30 absolute top-60 right-95 -rotate-0" src={aladin} alt="ilustracion lampara aladin" />
      <img className="w-45 absolute top-55 right-30 -rotate-0" src={pendulo} alt="pendulo 3d" />
    </div>
      {/* CURSOR */}
      <div
